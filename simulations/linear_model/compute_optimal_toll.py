...
An important assumption is that homes are owned by people within the region so that the aggregate welfare impact of rents is null
"""
...
for toll in range(0,101):
    ...
    df_optimal['aggregate_surplus'][toll] = float(df_sim['b_option'].sum()) / len(df_sim)
